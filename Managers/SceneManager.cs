...
namespace OpenGL_Game.Managers
{
    class SceneManager : GameWindow
    {
        ...
        {
            scene.Close();
            if (sceneType == SceneTypes.SCENE_NONE)
            {
                scene.Close();
            }
            if(sceneType == SceneTypes.SCENE_MAIN_MENU)
            {
                scene = new MainMenuScene(this);
            }
            ...
            if (sceneType == SceneTypes.SCENE_GAME_OVER)
            {
                scene = new GameOverScene(this);
            }
            if (sceneType == SceneTypes.SCENE_GAME_WIN)
            {
